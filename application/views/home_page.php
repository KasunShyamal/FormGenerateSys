    ...
    <div class="flex h-screen">
        ...
        <aside id="sidebar" class="bg-darker-purple flex-shrink-0 flex flex-col sidebar-transition sidebar-expanded">
            ...
            <nav class="mt-4 flex flex-col">
                ...
                <a href="<?= base_url('form/report'); ?>" class="sidebar-link flex items-center py-2 px-4 hover-bg-purple transition duration-200">
                    <i class="fas fa-chart-bar w-5 text-center"></i> <span class="ml-3 sidebar-text">Form Report</span>
                </a>
            </nav>
        </aside>
